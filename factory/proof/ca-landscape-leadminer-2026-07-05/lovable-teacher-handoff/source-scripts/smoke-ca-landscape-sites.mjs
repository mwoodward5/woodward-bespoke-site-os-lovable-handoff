...
async function check(url) {
  ...
  try {
    ...
    return {
      ...
      hasKitchenStack: /data-kitchen-stack=["']master-glue,razzle-fx,site-superpowers["']/.test(html),
...
const failures = results.flatMap((row) => [
  ...
  row.home.hasKitchenStack ? null : `${row.business} missing three-kitchen stack marker`,
