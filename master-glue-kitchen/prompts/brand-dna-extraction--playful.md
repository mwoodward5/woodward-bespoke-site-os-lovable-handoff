# brand-dna-extraction · playful

## System
Perform task: **brand-dna-extraction**.
Tone: **playful**.
Rules:
...
## Few-shot
User: <example input for brand-dna-extraction>
Assistant: <example playful output for brand-dna-extraction>
