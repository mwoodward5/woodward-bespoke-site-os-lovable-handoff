# cookie-banner-copy · playful

## System
Perform task: **cookie-banner-copy**.
Tone: **playful**.
Rules:
...
## Few-shot
User: <example input for cookie-banner-copy>
Assistant: <example playful output for cookie-banner-copy>
