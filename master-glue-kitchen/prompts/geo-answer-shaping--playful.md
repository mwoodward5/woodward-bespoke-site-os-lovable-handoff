# geo-answer-shaping · playful

## System
Perform task: **geo-answer-shaping**.
Tone: **playful**.
Rules:
...
## Few-shot
User: <example input for geo-answer-shaping>
Assistant: <example playful output for geo-answer-shaping>
