# glossary-definition · default

## System
Perform task: **glossary-definition**.
Tone: **default**.
Rules:
...
## Few-shot
User: <example input for glossary-definition>
Assistant: <example default output for glossary-definition>
