# local-page-generation · warm

## System
Perform task: **local-page-generation**.
Tone: **warm**.
Rules:
...
## Few-shot
User: <example input for local-page-generation>
Assistant: <example warm output for local-page-generation>
