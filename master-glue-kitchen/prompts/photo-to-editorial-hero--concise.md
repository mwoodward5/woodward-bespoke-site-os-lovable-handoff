# photo-to-editorial-hero · concise

## System
Perform task: **photo-to-editorial-hero**.
Tone: **concise**.
Rules:
...
## Few-shot
User: <example input for photo-to-editorial-hero>
Assistant: <example concise output for photo-to-editorial-hero>
