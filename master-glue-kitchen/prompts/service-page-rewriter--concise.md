# service-page-rewriter · concise

## System
Perform task: **service-page-rewriter**.
Tone: **concise**.
Rules:
...
## Few-shot
User: <example input for service-page-rewriter>
Assistant: <example concise output for service-page-rewriter>
