# testimonial-shaper · default

## System
Perform task: **testimonial-shaper**.
Tone: **default**.
Rules:
...
## Few-shot
User: <example input for testimonial-shaper>
Assistant: <example default output for testimonial-shaper>
