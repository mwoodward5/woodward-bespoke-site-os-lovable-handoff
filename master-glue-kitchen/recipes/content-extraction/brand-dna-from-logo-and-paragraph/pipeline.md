# Pipeline — Brand Dna From Logo And Paragraph
...
`/mnt/documents/brand-dna-from-logo-and-paragraph-report.json`.
...
{
  "input": "user_provided",
  "output": "/public/assets/rescued/brand-dna-from-logo-and-paragraph"
}
```
