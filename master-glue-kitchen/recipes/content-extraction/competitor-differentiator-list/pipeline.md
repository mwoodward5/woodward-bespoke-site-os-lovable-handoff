# Pipeline — Competitor Differentiator List
...
`/mnt/documents/competitor-differentiator-list-report.json`.
...
{
  "input": "user_provided",
  "output": "/public/assets/rescued/competitor-differentiator-list"
}
```
