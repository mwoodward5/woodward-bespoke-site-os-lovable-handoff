...
- "turn this into competitor scan"
- "extract competitor scan"
- "generate site copy from competitor scan"
- "build a page from competitor scan"
- "competitor scan"
...
## Refuse when
- User explicitly overrides via phrase: `skip competitor scan`
