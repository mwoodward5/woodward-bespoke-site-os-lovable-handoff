...
- "turn this into style guide md"
- "extract style guide md"
- "generate site copy from style guide md"
- "build a page from style guide md"
- "style guide md"
...
## Refuse when
- User explicitly overrides via phrase: `skip style guide md`
