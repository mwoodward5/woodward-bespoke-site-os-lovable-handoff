...
- "fix the logo vectorize"
- "rescue the logo vectorize"
- "remaster the logo vectorize"
- "make gorgeous: logo vectorize"
- "upgrade the logo vectorize"
- "logo vectorize"
...
## Refuse when
- User explicitly overrides via phrase: `skip logo vectorize`
