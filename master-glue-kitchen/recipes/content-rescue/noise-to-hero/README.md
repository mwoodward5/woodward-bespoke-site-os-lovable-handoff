...
- "fix the noise to hero"
- "rescue the noise to hero"
- "remaster the noise to hero"
- "make gorgeous: noise to hero"
- "upgrade the noise to hero"
- "noise to hero"
...
## Refuse when
- User explicitly overrides via phrase: `skip noise to hero`
