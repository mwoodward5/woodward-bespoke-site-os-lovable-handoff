...
- "deploy: redirects netlify"
- "dns: redirects netlify"
- "email: redirects netlify"
- "status: redirects netlify"
- "redirects netlify"
...
## Refuse when
- User explicitly overrides via phrase: `skip redirects netlify`
