...
- "lay it out as above fold matrix"
- "layout: above fold matrix"
- "use the above fold matrix"
- "grid: above fold matrix"
- "above fold matrix"
...
## Refuse when
- User explicitly overrides via phrase: `skip above fold matrix`
