...
- "lay it out as press logo strip"
- "layout: press logo strip"
- "use the press logo strip"
- "grid: press logo strip"
- "press logo strip"
...
## Refuse when
- User explicitly overrides via phrase: `skip press logo strip`
