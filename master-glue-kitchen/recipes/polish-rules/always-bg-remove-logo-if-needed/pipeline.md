# Pipeline — Always Bg Remove Logo If Needed
...
`/mnt/documents/always-bg-remove-logo-if-needed-report.json`.
...
{
  "input": "user_provided",
  "output": "/public/assets/rescued/always-bg-remove-logo-if-needed"
}
```
