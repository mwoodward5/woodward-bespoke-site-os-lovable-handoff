...
- "always always focus first"
- "never always focus first"
- "polish: always focus first"
- "auto-apply always focus first"
- "always focus first"
...
## Refuse when
- User explicitly overrides via phrase: `skip always focus first`
