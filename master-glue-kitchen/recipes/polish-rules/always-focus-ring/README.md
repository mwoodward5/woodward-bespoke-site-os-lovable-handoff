...
- "always always focus ring"
- "never always focus ring"
- "polish: always focus ring"
- "auto-apply always focus ring"
- "always focus ring"
...
## Refuse when
- User explicitly overrides via phrase: `skip always focus ring`
