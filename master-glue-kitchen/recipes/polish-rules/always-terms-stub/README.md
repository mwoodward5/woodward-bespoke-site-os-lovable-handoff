...
- "always always terms stub"
- "never always terms stub"
- "polish: always terms stub"
- "auto-apply always terms stub"
- "always terms stub"
...
## Refuse when
- User explicitly overrides via phrase: `skip always terms stub`
