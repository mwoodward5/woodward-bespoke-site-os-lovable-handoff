...
- "audit consent cookie audit"
- "QC consent cookie audit"
- "check consent cookie audit"
- "validate consent cookie audit"
- "consent cookie audit"
...
## Refuse when
- User explicitly overrides via phrase: `skip consent cookie audit`
