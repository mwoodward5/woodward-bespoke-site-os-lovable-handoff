...
- "audit gallery consistency"
- "QC gallery consistency"
- "check gallery consistency"
- "validate gallery consistency"
- "gallery consistency"
...
## Refuse when
- User explicitly overrides via phrase: `skip gallery consistency`
