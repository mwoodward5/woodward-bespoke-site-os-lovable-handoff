...
- "audit orphan page detector"
- "QC orphan page detector"
- "check orphan page detector"
- "validate orphan page detector"
- "orphan page detector"
...
## Refuse when
- User explicitly overrides via phrase: `skip orphan page detector`
