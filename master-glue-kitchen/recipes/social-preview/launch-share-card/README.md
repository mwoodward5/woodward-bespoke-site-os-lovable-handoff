...
- "social preview: launch share card"
- "share card: launch share card"
- "og: launch share card"
- "rich link: launch share card"
- "launch share card"
...
## Refuse when
- User explicitly overrides via phrase: `skip launch share card`
