...
**Category:** `a11y-seo`  **Perf tier:** moderate  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "make it a11y contrast check"
- "add a11y contrast check"
- "ship a11y contrast check"
- "annotate with a11y contrast check"
- "a11y contrast check"
- "a11y contrast check on the site"
