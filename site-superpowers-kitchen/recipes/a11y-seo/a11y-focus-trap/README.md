...
**Category:** `a11y-seo`  **Perf tier:** free  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "make it a11y focus trap"
- "add a11y focus trap"
- "ship a11y focus trap"
- "annotate with a11y focus trap"
- "a11y focus trap"
- "a11y focus trap on the site"
