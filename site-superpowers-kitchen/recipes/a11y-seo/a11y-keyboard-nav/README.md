...
**Category:** `a11y-seo`  **Perf tier:** moderate  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "make it a11y keyboard nav"
- "add a11y keyboard nav"
- "ship a11y keyboard nav"
- "annotate with a11y keyboard nav"
- "a11y keyboard nav"
- "a11y keyboard nav on the site"
