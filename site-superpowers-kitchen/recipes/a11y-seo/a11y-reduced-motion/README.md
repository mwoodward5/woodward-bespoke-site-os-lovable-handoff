...
**Category:** `a11y-seo`  **Perf tier:** moderate  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "make it a11y reduced motion"
- "add a11y reduced motion"
- "ship a11y reduced motion"
- "annotate with a11y reduced motion"
- "a11y reduced motion"
- "a11y reduced motion on the site"
