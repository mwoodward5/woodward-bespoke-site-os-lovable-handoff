...
**Category:** `a11y-seo`  **Perf tier:** cheap  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "make it seo jsonld breadcrumb"
- "add seo jsonld breadcrumb"
- "ship seo jsonld breadcrumb"
- "annotate with seo jsonld breadcrumb"
- "seo jsonld breadcrumb"
- "seo jsonld breadcrumb on the site"
