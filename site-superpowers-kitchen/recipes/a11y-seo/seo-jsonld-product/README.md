...
**Category:** `a11y-seo`  **Perf tier:** expensive  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "make it seo jsonld product"
- "add seo jsonld product"
- "ship seo jsonld product"
- "annotate with seo jsonld product"
- "seo jsonld product"
- "seo jsonld product on the site"
