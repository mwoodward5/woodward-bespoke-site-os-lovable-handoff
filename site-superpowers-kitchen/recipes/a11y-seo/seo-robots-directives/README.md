...
**Category:** `a11y-seo`  **Perf tier:** moderate  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional

## What it does
Accessibility or SEO primitive. Shipped as a required baseline, not polish.
...
- "make it seo robots directives"
- "add seo robots directives"
- "ship seo robots directives"
- "annotate with seo robots directives"
- "seo robots directives"
- "seo robots directives on the site"
