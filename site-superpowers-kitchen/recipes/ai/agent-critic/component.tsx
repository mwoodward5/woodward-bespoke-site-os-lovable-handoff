...
/**
 * Agent Critic — AI recipe
 * Talks to /api/agent-critic (server route) which proxies Lovable AI Gateway.
 */
export function SskAgentCritic() {
