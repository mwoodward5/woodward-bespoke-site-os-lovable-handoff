...
/**
 * Agent Planner — AI recipe
 * Talks to /api/agent-planner (server route) which proxies Lovable AI Gateway.
 */
export function SskAgentPlanner() {
...
export default SskAgentPlanner;
