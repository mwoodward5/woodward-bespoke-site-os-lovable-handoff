...
/**
 * Chat Moderation — AI recipe
 * Talks to /api/chat-moderation (server route) which proxies Lovable AI Gateway.
 */
export function SskChatModeration() {
...
export default SskChatModeration;
