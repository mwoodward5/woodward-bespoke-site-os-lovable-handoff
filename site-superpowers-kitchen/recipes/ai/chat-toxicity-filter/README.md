# Chat Toxicity Filter

**Category:** `ai`  **Perf tier:** free  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "add a chat toxicity filter"
- "give me a chat toxicity filter"
- "wire up a chat toxicity filter"
- "build a chat toxicity filter"
- "chat toxicity filter"
- "chat toxicity filter on the site"
