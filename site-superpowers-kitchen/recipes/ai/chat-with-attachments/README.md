...
**Category:** `ai`  **Perf tier:** moderate  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "add a chat with attachments"
- "give me a chat with attachments"
- "wire up a chat with attachments"
- "build a chat with attachments"
- "chat with attachments"
- "chat with attachments on the site"
