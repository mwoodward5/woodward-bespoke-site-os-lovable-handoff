...
/**
 * Chat With Pdf — AI recipe
 * Talks to /api/chat-with-pdf (server route) which proxies Lovable AI Gateway.
 */
export function SskChatWithPdf() {
