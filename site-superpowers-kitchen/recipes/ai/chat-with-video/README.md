...
**Category:** `ai`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** yes
...
- "add a chat with video"
- "give me a chat with video"
- "wire up a chat with video"
- "build a chat with video"
- "chat with video"
- "chat with video on the site"
