...
/**
 * Classify Intent — AI recipe
 * Talks to /api/classify-intent (server route) which proxies Lovable AI Gateway.
 */
export function SskClassifyIntent() {
...
export default SskClassifyIntent;
