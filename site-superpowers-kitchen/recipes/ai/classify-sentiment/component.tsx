...
/**
 * Classify Sentiment — AI recipe
 * Talks to /api/classify-sentiment (server route) which proxies Lovable AI Gateway.
 */
export function SskClassifySentiment() {
...
export default SskClassifySentiment;
