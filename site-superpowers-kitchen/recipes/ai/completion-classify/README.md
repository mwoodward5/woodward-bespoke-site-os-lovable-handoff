...
**Category:** `ai`  **Perf tier:** free  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "add a completion classify"
- "give me a completion classify"
- "wire up a completion classify"
- "build a completion classify"
- "completion classify"
- "completion classify on the site"
