...
- "add a completion code explain"
- "give me a completion code explain"
- "wire up a completion code explain"
- "build a completion code explain"
- "completion code explain"
- "completion code explain on the site"
