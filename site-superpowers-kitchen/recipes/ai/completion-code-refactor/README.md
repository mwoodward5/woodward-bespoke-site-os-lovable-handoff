...
- "add a completion code refactor"
- "give me a completion code refactor"
- "wire up a completion code refactor"
- "build a completion code refactor"
- "completion code refactor"
- "completion code refactor on the site"
