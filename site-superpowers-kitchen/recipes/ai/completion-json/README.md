...
**Category:** `ai`  **Perf tier:** moderate  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "add a completion json"
- "give me a completion json"
- "wire up a completion json"
- "build a completion json"
- "completion json"
- "completion json on the site"
