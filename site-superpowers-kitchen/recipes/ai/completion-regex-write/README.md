# Completion Regex Write

**Category:** `ai`  **Perf tier:** expensive  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "add a completion regex write"
- "give me a completion regex write"
- "wire up a completion regex write"
- "build a completion regex write"
- "completion regex write"
- "completion regex write on the site"
