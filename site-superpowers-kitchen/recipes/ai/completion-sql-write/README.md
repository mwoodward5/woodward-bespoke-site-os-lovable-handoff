...
- "add a completion sql write"
- "give me a completion sql write"
- "wire up a completion sql write"
- "build a completion sql write"
- "completion sql write"
- "completion sql write on the site"
