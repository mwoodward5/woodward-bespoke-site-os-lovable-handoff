...
**Category:** `ai`  **Perf tier:** moderate  **Cost tier:** moderate  **Depends on Lovable Cloud:** yes
...
- "add a completion structured"
- "give me a completion structured"
- "wire up a completion structured"
- "build a completion structured"
- "completion structured"
- "completion structured on the site"
