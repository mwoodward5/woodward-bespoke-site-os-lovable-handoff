...
/**
 * Extract Entities — AI recipe
 * Talks to /api/extract-entities (server route) which proxies Lovable AI Gateway.
 */
export function SskExtractEntities() {
...
export default SskExtractEntities;
