...
/**
 * Extract Form — AI recipe
 * Talks to /api/extract-form (server route) which proxies Lovable AI Gateway.
 */
export function SskExtractForm() {
