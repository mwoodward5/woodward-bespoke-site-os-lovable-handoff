...
/**
 * Extract Invoice — AI recipe
 * Talks to /api/extract-invoice (server route) which proxies Lovable AI Gateway.
 */
export function SskExtractInvoice() {
...
export default SskExtractInvoice;
