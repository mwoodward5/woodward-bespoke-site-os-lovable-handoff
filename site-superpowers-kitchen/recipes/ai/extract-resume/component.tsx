...
/**
 * Extract Resume — AI recipe
 * Talks to /api/extract-resume (server route) which proxies Lovable AI Gateway.
 */
export function SskExtractResume() {
...
export default SskExtractResume;
