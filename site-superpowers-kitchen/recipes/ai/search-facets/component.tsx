...
/**
 * Search Facets — AI recipe
 * Talks to /api/search-facets (server route) which proxies Lovable AI Gateway.
 */
export function SskSearchFacets() {
...
export default SskSearchFacets;
