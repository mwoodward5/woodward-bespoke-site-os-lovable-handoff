...
/**
 * Search Hybrid — AI recipe
 * Talks to /api/search-hybrid (server route) which proxies Lovable AI Gateway.
 */
export function SskSearchHybrid() {
...
export default SskSearchHybrid;
