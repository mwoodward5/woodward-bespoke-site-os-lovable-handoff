...
/**
 * Search Semantic — AI recipe
 * Talks to /api/search-semantic (server route) which proxies Lovable AI Gateway.
 */
export function SskSearchSemantic() {
...
export default SskSearchSemantic;
