...
**Category:** `auth`  **Perf tier:** expensive  **Cost tier:** cheap  **Depends on Lovable Cloud:** yes
...
- "add auth 2fa totp"
- "use auth 2fa totp"
- "gate this with auth 2fa totp"
- "protect with auth 2fa totp"
- "auth 2fa totp"
- "auth 2fa totp on the site"
