...
**Category:** `auth`  **Perf tier:** moderate  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "add auth account delete"
- "use auth account delete"
- "gate this with auth account delete"
- "protect with auth account delete"
- "auth account delete"
- "auth account delete on the site"
