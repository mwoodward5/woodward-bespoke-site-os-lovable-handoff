# Auth Anonymous Guard

**Category:** `auth`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** yes

## What it does
Authentication or identity primitive. Server-verified, RLS-aware.
...
- "add auth anonymous guard"
- "use auth anonymous guard"
- "gate this with auth anonymous guard"
- "protect with auth anonymous guard"
- "auth anonymous guard"
- "auth anonymous guard on the site"
