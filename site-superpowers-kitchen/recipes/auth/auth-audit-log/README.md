...
**Category:** `auth`  **Perf tier:** moderate  **Cost tier:** cheap  **Depends on Lovable Cloud:** yes
...
- "add auth audit log"
- "use auth audit log"
- "gate this with auth audit log"
- "protect with auth audit log"
- "auth audit log"
- "auth audit log on the site"
