...
**Category:** `auth`  **Perf tier:** expensive  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "add auth brute force guard"
- "use auth brute force guard"
- "gate this with auth brute force guard"
- "protect with auth brute force guard"
- "auth brute force guard"
- "auth brute force guard on the site"
