...
**Category:** `auth`  **Perf tier:** cheap  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "use auth email verify"
- "gate this with auth email verify"
- "protect with auth email verify"
- "auth email verify"
- "auth email verify on the site"
