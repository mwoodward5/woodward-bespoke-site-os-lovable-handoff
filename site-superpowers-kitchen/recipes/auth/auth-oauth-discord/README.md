...
**Category:** `auth`  **Perf tier:** free  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "add auth oauth discord"
- "use auth oauth discord"
- "gate this with auth oauth discord"
- "protect with auth oauth discord"
- "auth oauth discord"
- "auth oauth discord on the site"
