...
**Category:** `auth`  **Perf tier:** expensive  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "add auth password reset"
- "use auth password reset"
- "gate this with auth password reset"
- "protect with auth password reset"
- "auth password reset"
- "auth password reset on the site"
