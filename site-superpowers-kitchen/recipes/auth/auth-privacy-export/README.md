...
**Category:** `auth`  **Perf tier:** free  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "add auth privacy export"
- "use auth privacy export"
- "gate this with auth privacy export"
- "protect with auth privacy export"
- "auth privacy export"
- "auth privacy export on the site"
