...
**Category:** `auth`  **Perf tier:** free  **Cost tier:** cheap  **Depends on Lovable Cloud:** yes
...
- "add auth rate limit"
- "use auth rate limit"
- "gate this with auth rate limit"
- "protect with auth rate limit"
- "auth rate limit"
- "auth rate limit on the site"
