...
**Category:** `auth`  **Perf tier:** cheap  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "add auth signout all"
- "use auth signout all"
- "gate this with auth signout all"
- "protect with auth signout all"
- "auth signout all"
- "auth signout all on the site"
