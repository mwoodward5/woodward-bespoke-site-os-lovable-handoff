...
**Category:** `auth`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** yes
...
- "add auth team invite"
- "use auth team invite"
- "gate this with auth team invite"
- "protect with auth team invite"
- "auth team invite"
- "auth team invite on the site"
