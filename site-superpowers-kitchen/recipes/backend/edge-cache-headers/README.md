...
**Category:** `backend`  **Perf tier:** cheap  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "add a edge cache headers"
- "wire up edge cache headers"
- "expose edge cache headers"
- "schedule edge cache headers"
- "edge cache headers"
- "edge cache headers on the site"
