...
**Category:** `backend`  **Perf tier:** moderate  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "add a route api public"
- "wire up route api public"
- "expose route api public"
- "schedule route api public"
- "route api public"
- "route api public on the site"
