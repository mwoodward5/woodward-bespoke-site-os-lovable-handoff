...
**Category:** `backend`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "add a route api signed"
- "wire up route api signed"
- "expose route api signed"
- "schedule route api signed"
- "route api signed"
- "route api signed on the site"
