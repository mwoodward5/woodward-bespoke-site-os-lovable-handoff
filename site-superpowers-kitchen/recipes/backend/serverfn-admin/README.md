...
**Category:** `backend`  **Perf tier:** cheap  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "add a serverfn admin"
- "wire up serverfn admin"
- "expose serverfn admin"
- "schedule serverfn admin"
- "serverfn admin"
- "serverfn admin on the site"
