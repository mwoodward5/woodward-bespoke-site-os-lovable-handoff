...
**Category:** `backend`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "add a serverfn basic"
- "wire up serverfn basic"
- "expose serverfn basic"
- "schedule serverfn basic"
- "serverfn basic"
- "serverfn basic on the site"
