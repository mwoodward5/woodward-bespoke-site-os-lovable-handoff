...
**Category:** `backend`  **Perf tier:** cheap  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "add a webhook github"
- "wire up webhook github"
- "expose webhook github"
- "schedule webhook github"
- "webhook github"
- "webhook github on the site"
