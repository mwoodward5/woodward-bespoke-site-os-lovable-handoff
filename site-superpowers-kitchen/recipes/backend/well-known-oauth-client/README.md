...
**Category:** `backend`  **Perf tier:** expensive  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "add a well known oauth client"
- "wire up well known oauth client"
- "expose well known oauth client"
- "schedule well known oauth client"
- "well known oauth client"
- "well known oauth client on the site"
