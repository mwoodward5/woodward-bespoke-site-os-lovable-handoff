...
**Category:** `data`  **Perf tier:** expensive  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "let users analytics events"
- "export as analytics events"
- "search with analytics events"
- "chart analytics events"
- "analytics events"
- "analytics events on the site"
