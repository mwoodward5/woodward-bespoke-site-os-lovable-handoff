...
**Category:** `data`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "let users analytics funnel"
- "export as analytics funnel"
- "search with analytics funnel"
- "chart analytics funnel"
- "analytics funnel"
- "analytics funnel on the site"
