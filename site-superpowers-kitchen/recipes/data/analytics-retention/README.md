...
**Category:** `data`  **Perf tier:** free  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "let users analytics retention"
- "export as analytics retention"
- "search with analytics retention"
- "chart analytics retention"
- "analytics retention"
- "analytics retention on the site"
