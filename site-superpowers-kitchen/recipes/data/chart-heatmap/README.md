...
**Category:** `data`  **Perf tier:** moderate  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "let users chart heatmap"
- "export as chart heatmap"
- "search with chart heatmap"
- "chart chart heatmap"
- "chart heatmap"
- "chart heatmap on the site"
