...
**Category:** `data`  **Perf tier:** expensive  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "let users chart line"
- "export as chart line"
- "search with chart line"
- "chart chart line"
- "chart line"
- "chart line on the site"
