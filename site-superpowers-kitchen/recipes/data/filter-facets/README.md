...
**Category:** `data`  **Perf tier:** cheap  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "let users filter facets"
- "export as filter facets"
- "search with filter facets"
- "chart filter facets"
- "filter facets"
- "filter facets on the site"
