...
**Category:** `data`  **Perf tier:** free  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "let users pdf generate"
- "export as pdf generate"
- "search with pdf generate"
- "chart pdf generate"
- "pdf generate"
- "pdf generate on the site"
