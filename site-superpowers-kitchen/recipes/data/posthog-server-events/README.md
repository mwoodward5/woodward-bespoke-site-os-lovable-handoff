...
**Category:** `data`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "let users posthog server events"
- "export as posthog server events"
- "search with posthog server events"
- "chart posthog server events"
- "posthog server events"
- "posthog server events on the site"
