...
**Category:** `data`  **Perf tier:** moderate  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "let users search fulltext"
- "export as search fulltext"
- "search with search fulltext"
- "chart search fulltext"
- "search fulltext"
- "search fulltext on the site"
