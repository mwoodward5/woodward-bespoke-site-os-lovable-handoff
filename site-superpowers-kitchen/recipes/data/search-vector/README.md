...
**Category:** `data`  **Perf tier:** expensive  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "let users search vector"
- "export as search vector"
- "search with search vector"
- "chart search vector"
- "search vector"
- "search vector on the site"
