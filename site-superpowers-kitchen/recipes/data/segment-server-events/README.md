...
**Category:** `data`  **Perf tier:** moderate  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional

## What it does
Data, search, export, or charts primitive.
...
- "let users segment server events"
- "export as segment server events"
- "search with segment server events"
- "chart segment server events"
- "segment server events"
- "segment server events on the site"
