...
**Category:** `data`  **Perf tier:** cheap  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "let users xlsx export"
- "export as xlsx export"
- "search with xlsx export"
- "chart xlsx export"
- "xlsx export"
- "xlsx export on the site"
