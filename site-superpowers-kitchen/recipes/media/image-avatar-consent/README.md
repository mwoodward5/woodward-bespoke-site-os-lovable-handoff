# Image Avatar Consent

**Category:** `media`  **Perf tier:** moderate  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "generate image avatar consent"
- "edit the image with image avatar consent"
- "use image avatar consent"
- "add a media flow for image avatar consent"
- "image avatar consent"
- "image avatar consent on the site"
