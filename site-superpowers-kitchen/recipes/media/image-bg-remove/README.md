...
**Category:** `media`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "generate image bg remove"
- "edit the image with image bg remove"
- "use image bg remove"
- "add a media flow for image bg remove"
- "image bg remove"
- "image bg remove on the site"
