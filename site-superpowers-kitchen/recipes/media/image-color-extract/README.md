...
- "generate image color extract"
- "edit the image with image color extract"
- "use image color extract"
- "add a media flow for image color extract"
- "image color extract"
- "image color extract on the site"
