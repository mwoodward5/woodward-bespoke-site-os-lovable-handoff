# Image Download Safeguard

**Category:** `media`  **Perf tier:** cheap  **Cost tier:** free  **Depends on Lovable Cloud:** optional

## What it does
Media generation, editing, or analysis. Uses Lovable AI where possible, external providers when explicitly required.
...
- "generate image download safeguard"
- "edit the image with image download safeguard"
- "use image download safeguard"
- "add a media flow for image download safeguard"
- "image download safeguard"
- "image download safeguard on the site"
