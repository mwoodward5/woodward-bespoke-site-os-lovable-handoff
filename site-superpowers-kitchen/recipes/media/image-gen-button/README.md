...
**Category:** `media`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "generate image gen button"
- "edit the image with image gen button"
- "use image gen button"
- "add a media flow for image gen button"
- "image gen button"
- "image gen button on the site"
