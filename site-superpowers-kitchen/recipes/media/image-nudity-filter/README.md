...
**Category:** `media`  **Perf tier:** moderate  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "generate image nudity filter"
- "edit the image with image nudity filter"
- "use image nudity filter"
- "add a media flow for image nudity filter"
- "image nudity filter"
- "image nudity filter on the site"
