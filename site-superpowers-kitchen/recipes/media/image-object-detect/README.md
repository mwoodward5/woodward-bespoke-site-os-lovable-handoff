...
**Category:** `media`  **Perf tier:** expensive  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "generate image object detect"
- "edit the image with image object detect"
- "use image object detect"
- "add a media flow for image object detect"
- "image object detect"
- "image object detect on the site"
