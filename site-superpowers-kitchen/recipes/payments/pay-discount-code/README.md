...
**Category:** `payments`  **Perf tier:** expensive  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "accept payments via pay discount code"
- "charge with pay discount code"
- "paywall with pay discount code"
- "use pay discount code"
- "pay discount code"
- "pay discount code on the site"
