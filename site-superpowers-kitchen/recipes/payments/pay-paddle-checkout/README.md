...
**Category:** `payments`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** yes
...
- "accept payments via pay paddle checkout"
- "charge with pay paddle checkout"
- "paywall with pay paddle checkout"
- "use pay paddle checkout"
- "pay paddle checkout"
- "pay paddle checkout on the site"
