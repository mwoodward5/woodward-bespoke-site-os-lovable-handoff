# Pay Stripe Marketplace

**Category:** `payments`  **Perf tier:** moderate  **Cost tier:** cheap  **Depends on Lovable Cloud:** yes

## What it does
Payments scaffold. Webhook-verified, idempotent.
...
- "accept payments via pay stripe marketplace"
- "charge with pay stripe marketplace"
- "paywall with pay stripe marketplace"
- "use pay stripe marketplace"
- "pay stripe marketplace"
- "pay stripe marketplace on the site"
