...
**Category:** `payments`  **Perf tier:** cheap  **Cost tier:** cheap  **Depends on Lovable Cloud:** yes
...
- "accept payments via pay trial banner"
- "charge with pay trial banner"
- "paywall with pay trial banner"
- "use pay trial banner"
- "pay trial banner"
- "pay trial banner on the site"
