...
**Category:** `payments`  **Perf tier:** moderate  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "accept payments via pay upgrade cta"
- "charge with pay upgrade cta"
- "paywall with pay upgrade cta"
- "use pay upgrade cta"
- "pay upgrade cta"
- "pay upgrade cta on the site"
