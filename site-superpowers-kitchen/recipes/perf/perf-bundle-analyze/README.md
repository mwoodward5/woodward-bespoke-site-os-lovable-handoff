...
**Category:** `perf`  **Perf tier:** cheap  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "optimize with perf bundle analyze"
- "measure perf bundle analyze"
- "gate heavy stuff with perf bundle analyze"
- "preload perf bundle analyze"
- "perf bundle analyze"
- "perf bundle analyze on the site"
