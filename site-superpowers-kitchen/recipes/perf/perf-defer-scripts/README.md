...
**Category:** `perf`  **Perf tier:** free  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "optimize with perf defer scripts"
- "measure perf defer scripts"
- "gate heavy stuff with perf defer scripts"
- "preload perf defer scripts"
- "perf defer scripts"
- "perf defer scripts on the site"
