# Perf Heavy Anim Gate

**Category:** `perf`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "optimize with perf heavy anim gate"
- "measure perf heavy anim gate"
- "gate heavy stuff with perf heavy anim gate"
- "preload perf heavy anim gate"
- "perf heavy anim gate"
- "perf heavy anim gate on the site"
