# Perf Image Natural Guard

**Category:** `perf`  **Perf tier:** cheap  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "optimize with perf image natural guard"
- "measure perf image natural guard"
- "gate heavy stuff with perf image natural guard"
- "preload perf image natural guard"
- "perf image natural guard"
- "perf image natural guard on the site"
