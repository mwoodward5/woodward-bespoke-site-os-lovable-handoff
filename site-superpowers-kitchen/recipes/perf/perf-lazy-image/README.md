...
**Category:** `perf`  **Perf tier:** free  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "optimize with perf lazy image"
- "measure perf lazy image"
- "gate heavy stuff with perf lazy image"
- "preload perf lazy image"
- "perf lazy image"
- "perf lazy image on the site"
