...
**Category:** `perf`  **Perf tier:** expensive  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "optimize with perf noise cheap"
- "measure perf noise cheap"
- "gate heavy stuff with perf noise cheap"
- "preload perf noise cheap"
- "perf noise cheap"
- "perf noise cheap on the site"
