...
**Category:** `perf`  **Perf tier:** cheap  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "optimize with perf offline shell"
- "measure perf offline shell"
- "gate heavy stuff with perf offline shell"
- "preload perf offline shell"
- "perf offline shell"
- "perf offline shell on the site"
