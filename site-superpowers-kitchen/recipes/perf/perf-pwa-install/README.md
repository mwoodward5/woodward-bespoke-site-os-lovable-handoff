...
**Category:** `perf`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "optimize with perf pwa install"
- "measure perf pwa install"
- "gate heavy stuff with perf pwa install"
- "preload perf pwa install"
- "perf pwa install"
- "perf pwa install on the site"
