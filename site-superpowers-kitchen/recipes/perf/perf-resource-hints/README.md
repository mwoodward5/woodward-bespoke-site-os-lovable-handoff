...
**Category:** `perf`  **Perf tier:** expensive  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "optimize with perf resource hints"
- "measure perf resource hints"
- "gate heavy stuff with perf resource hints"
- "preload perf resource hints"
- "perf resource hints"
- "perf resource hints on the site"
