...
**Category:** `perf`  **Perf tier:** moderate  **Cost tier:** free  **Depends on Lovable Cloud:** optional
...
- "optimize with perf service worker"
- "measure perf service worker"
- "gate heavy stuff with perf service worker"
- "preload perf service worker"
- "perf service worker"
- "perf service worker on the site"
