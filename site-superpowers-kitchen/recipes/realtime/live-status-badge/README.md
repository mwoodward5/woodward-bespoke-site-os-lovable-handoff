...
**Category:** `realtime`  **Perf tier:** free  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "show live live status badge"
- "broadcast live status badge"
- "stream live status badge"
- "subscribe to live status badge"
- "live status badge"
- "live status badge on the site"
