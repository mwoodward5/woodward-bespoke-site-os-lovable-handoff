...
**Category:** `realtime`  **Perf tier:** free  **Cost tier:** moderate  **Depends on Lovable Cloud:** yes
...
- "show live optimistic mutations"
- "broadcast optimistic mutations"
- "stream optimistic mutations"
- "subscribe to optimistic mutations"
- "optimistic mutations"
- "optimistic mutations on the site"
