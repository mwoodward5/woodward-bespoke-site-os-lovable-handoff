...
**Category:** `realtime`  **Perf tier:** cheap  **Cost tier:** free  **Depends on Lovable Cloud:** yes
...
- "show live sse progress bar"
- "broadcast sse progress bar"
- "stream sse progress bar"
- "subscribe to sse progress bar"
- "sse progress bar"
- "sse progress bar on the site"
