# Dashboard Resize Grid

**Category:** `ux`  **Perf tier:** free  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "add a dashboard resize grid"
- "give me a dashboard resize grid"
- "wire up a dashboard resize grid"
- "ship a dashboard resize grid"
- "dashboard resize grid"
- "dashboard resize grid on the site"
