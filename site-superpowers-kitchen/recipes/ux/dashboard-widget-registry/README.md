...
**Category:** `ux`  **Perf tier:** expensive  **Cost tier:** moderate  **Depends on Lovable Cloud:** optional
...
- "add a dashboard widget registry"
- "give me a dashboard widget registry"
- "wire up a dashboard widget registry"
- "ship a dashboard widget registry"
- "dashboard widget registry"
- "dashboard widget registry on the site"
