...
**Category:** `ux`  **Perf tier:** expensive  **Cost tier:** expensive  **Depends on Lovable Cloud:** optional
...
- "add a form signature pad"
- "give me a form signature pad"
- "wire up a form signature pad"
- "ship a form signature pad"
- "form signature pad"
- "form signature pad on the site"
