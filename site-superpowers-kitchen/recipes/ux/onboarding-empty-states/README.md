...
**Category:** `ux`  **Perf tier:** cheap  **Cost tier:** cheap  **Depends on Lovable Cloud:** optional
...
- "add a onboarding empty states"
- "give me a onboarding empty states"
- "wire up a onboarding empty states"
- "ship a onboarding empty states"
- "onboarding empty states"
- "onboarding empty states on the site"
