...
/**
 * Audio Ambient Loop — Voice recipe
 * SSE-streams PCM from /api/audio-ambient-loop into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskAudioAmbientLoop() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/audio-ambient-loop", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskAudioAmbientLoop;
