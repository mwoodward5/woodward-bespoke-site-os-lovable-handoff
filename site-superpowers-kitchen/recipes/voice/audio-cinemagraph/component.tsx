...
/**
 * Audio Cinemagraph — Voice recipe
 * SSE-streams PCM from /api/audio-cinemagraph into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskAudioCinemagraph() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/audio-cinemagraph", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskAudioCinemagraph;
