# Audio Notification Cues

**Category:** `voice`  **Perf tier:** expensive  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "let the site audio notification cues"
- "read aloud with audio notification cues"
- "narrate with audio notification cues"
- "use audio notification cues"
- "audio notification cues"
- "audio notification cues on the site"
