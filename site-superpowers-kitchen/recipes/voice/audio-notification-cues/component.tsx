...
/**
 * Audio Notification Cues — Voice recipe
 * SSE-streams PCM from /api/audio-notification-cues into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskAudioNotificationCues() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/audio-notification-cues", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskAudioNotificationCues;
