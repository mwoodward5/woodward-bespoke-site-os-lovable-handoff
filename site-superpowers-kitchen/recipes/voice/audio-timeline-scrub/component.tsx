...
/**
 * Audio Timeline Scrub — Voice recipe
 * SSE-streams PCM from /api/audio-timeline-scrub into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskAudioTimelineScrub() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/audio-timeline-scrub", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskAudioTimelineScrub;
