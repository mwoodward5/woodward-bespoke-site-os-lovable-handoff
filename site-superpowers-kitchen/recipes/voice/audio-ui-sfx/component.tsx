...
/**
 * Audio Ui Sfx — Voice recipe
 * SSE-streams PCM from /api/audio-ui-sfx into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskAudioUiSfx() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/audio-ui-sfx", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
