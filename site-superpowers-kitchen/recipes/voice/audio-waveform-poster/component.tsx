...
/**
 * Audio Waveform Poster — Voice recipe
 * SSE-streams PCM from /api/audio-waveform-poster into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskAudioWaveformPoster() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/audio-waveform-poster", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskAudioWaveformPoster;
