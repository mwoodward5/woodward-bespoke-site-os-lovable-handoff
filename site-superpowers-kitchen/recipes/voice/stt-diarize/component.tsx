...
/**
 * Stt Diarize — Voice recipe
 * SSE-streams PCM from /api/stt-diarize into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttDiarize() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-diarize", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
