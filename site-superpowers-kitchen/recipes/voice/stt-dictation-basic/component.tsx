...
/**
 * Stt Dictation Basic — Voice recipe
 * SSE-streams PCM from /api/stt-dictation-basic into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttDictationBasic() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-dictation-basic", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttDictationBasic;
