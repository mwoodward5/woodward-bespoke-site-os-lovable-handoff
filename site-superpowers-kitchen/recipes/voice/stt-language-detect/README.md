...
**Category:** `voice`  **Perf tier:** moderate  **Cost tier:** expensive  **Depends on Lovable Cloud:** yes
...
- "let the site stt language detect"
- "read aloud with stt language detect"
- "narrate with stt language detect"
- "use stt language detect"
- "stt language detect"
- "stt language detect on the site"
