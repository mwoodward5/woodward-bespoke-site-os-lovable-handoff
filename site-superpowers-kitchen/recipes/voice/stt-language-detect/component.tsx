...
/**
 * Stt Language Detect — Voice recipe
 * SSE-streams PCM from /api/stt-language-detect into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttLanguageDetect() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-language-detect", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttLanguageDetect;
