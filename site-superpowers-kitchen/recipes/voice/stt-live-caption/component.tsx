...
/**
 * Stt Live Caption — Voice recipe
 * SSE-streams PCM from /api/stt-live-caption into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttLiveCaption() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-live-caption", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttLiveCaption;
