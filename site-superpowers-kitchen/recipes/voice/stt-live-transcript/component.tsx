...
/**
 * Stt Live Transcript — Voice recipe
 * SSE-streams PCM from /api/stt-live-transcript into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttLiveTranscript() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-live-transcript", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttLiveTranscript;
