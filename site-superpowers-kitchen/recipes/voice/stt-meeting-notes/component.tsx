...
/**
 * Stt Meeting Notes — Voice recipe
 * SSE-streams PCM from /api/stt-meeting-notes into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttMeetingNotes() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-meeting-notes", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttMeetingNotes;
