...
/**
 * Stt Punctuation — Voice recipe
 * SSE-streams PCM from /api/stt-punctuation into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttPunctuation() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-punctuation", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttPunctuation;
