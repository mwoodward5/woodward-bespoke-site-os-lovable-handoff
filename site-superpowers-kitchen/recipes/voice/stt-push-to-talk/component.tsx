...
/**
 * Stt Push To Talk — Voice recipe
 * SSE-streams PCM from /api/stt-push-to-talk into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttPushToTalk() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-push-to-talk", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttPushToTalk;
