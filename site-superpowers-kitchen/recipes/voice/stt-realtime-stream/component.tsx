...
/**
 * Stt Realtime Stream — Voice recipe
 * SSE-streams PCM from /api/stt-realtime-stream into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttRealtimeStream() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-realtime-stream", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttRealtimeStream;
