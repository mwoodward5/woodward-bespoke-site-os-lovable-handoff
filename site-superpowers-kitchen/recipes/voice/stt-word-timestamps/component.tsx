...
/**
 * Stt Word Timestamps — Voice recipe
 * SSE-streams PCM from /api/stt-word-timestamps into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskSttWordTimestamps() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/stt-word-timestamps", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskSttWordTimestamps;
