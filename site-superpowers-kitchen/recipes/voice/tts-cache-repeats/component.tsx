...
/**
 * Tts Cache Repeats — Voice recipe
 * SSE-streams PCM from /api/tts-cache-repeats into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsCacheRepeats() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-cache-repeats", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsCacheRepeats;
