...
/**
 * Tts Cancel — Voice recipe
 * SSE-streams PCM from /api/tts-cancel into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsCancel() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-cancel", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
