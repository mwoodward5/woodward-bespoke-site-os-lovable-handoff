...
/**
 * Tts Chunker — Voice recipe
 * SSE-streams PCM from /api/tts-chunker into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsChunker() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-chunker", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
