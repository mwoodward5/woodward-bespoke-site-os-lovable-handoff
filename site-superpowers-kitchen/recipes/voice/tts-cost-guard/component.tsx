...
/**
 * Tts Cost Guard — Voice recipe
 * SSE-streams PCM from /api/tts-cost-guard into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsCostGuard() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-cost-guard", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsCostGuard;
