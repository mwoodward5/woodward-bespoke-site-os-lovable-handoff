...
/**
 * Tts Download Mp3 — Voice recipe
 * SSE-streams PCM from /api/tts-download-mp3 into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsDownloadMp3() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-download-mp3", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsDownloadMp3;
