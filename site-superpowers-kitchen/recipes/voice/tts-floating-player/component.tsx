...
/**
 * Tts Floating Player — Voice recipe
 * SSE-streams PCM from /api/tts-floating-player into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsFloatingPlayer() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-floating-player", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsFloatingPlayer;
