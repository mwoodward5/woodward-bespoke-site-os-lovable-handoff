...
/**
 * Tts Language Switch — Voice recipe
 * SSE-streams PCM from /api/tts-language-switch into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsLanguageSwitch() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-language-switch", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsLanguageSwitch;
