...
/**
 * Tts Multivoice Dialogue — Voice recipe
 * SSE-streams PCM from /api/tts-multivoice-dialogue into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsMultivoiceDialogue() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-multivoice-dialogue", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsMultivoiceDialogue;
