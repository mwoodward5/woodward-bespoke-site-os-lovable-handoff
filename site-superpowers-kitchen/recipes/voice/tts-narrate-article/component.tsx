...
/**
 * Tts Narrate Article — Voice recipe
 * SSE-streams PCM from /api/tts-narrate-article into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsNarrateArticle() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-narrate-article", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsNarrateArticle;
