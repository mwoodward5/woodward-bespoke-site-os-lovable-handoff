...
/**
 * Tts Narrate Paragraph — Voice recipe
 * SSE-streams PCM from /api/tts-narrate-paragraph into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsNarrateParagraph() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-narrate-paragraph", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsNarrateParagraph;
