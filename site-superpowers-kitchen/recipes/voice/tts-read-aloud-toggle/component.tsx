...
/**
 * Tts Read Aloud Toggle — Voice recipe
 * SSE-streams PCM from /api/tts-read-aloud-toggle into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsReadAloudToggle() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-read-aloud-toggle", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsReadAloudToggle;
