...
/**
 * Tts Realtime Lowlatency — Voice recipe
 * SSE-streams PCM from /api/tts-realtime-lowlatency into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsRealtimeLowlatency() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-realtime-lowlatency", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsRealtimeLowlatency;
