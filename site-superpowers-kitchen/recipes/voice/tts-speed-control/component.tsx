...
/**
 * Tts Speed Control — Voice recipe
 * SSE-streams PCM from /api/tts-speed-control into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsSpeedControl() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-speed-control", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsSpeedControl;
