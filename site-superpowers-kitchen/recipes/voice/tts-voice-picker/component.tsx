...
/**
 * Tts Voice Picker — Voice recipe
 * SSE-streams PCM from /api/tts-voice-picker into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskTtsVoicePicker() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/tts-voice-picker", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskTtsVoicePicker;
