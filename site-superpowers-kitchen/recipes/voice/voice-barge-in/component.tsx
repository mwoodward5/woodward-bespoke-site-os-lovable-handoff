...
/**
 * Voice Barge In — Voice recipe
 * SSE-streams PCM from /api/voice-barge-in into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceBargeIn() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-barge-in", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceBargeIn;
