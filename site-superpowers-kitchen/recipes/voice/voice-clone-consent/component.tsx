...
/**
 * Voice Clone Consent — Voice recipe
 * SSE-streams PCM from /api/voice-clone-consent into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceCloneConsent() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-clone-consent", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceCloneConsent;
