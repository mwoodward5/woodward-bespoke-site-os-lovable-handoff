...
/**
 * Voice Clone Preview — Voice recipe
 * SSE-streams PCM from /api/voice-clone-preview into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceClonePreview() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-clone-preview", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceClonePreview;
