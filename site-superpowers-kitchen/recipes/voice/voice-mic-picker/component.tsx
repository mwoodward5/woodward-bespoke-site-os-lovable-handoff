...
/**
 * Voice Mic Picker — Voice recipe
 * SSE-streams PCM from /api/voice-mic-picker into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceMicPicker() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-mic-picker", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceMicPicker;
