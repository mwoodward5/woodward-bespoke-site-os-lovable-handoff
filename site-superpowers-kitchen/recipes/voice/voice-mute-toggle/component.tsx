...
/**
 * Voice Mute Toggle — Voice recipe
 * SSE-streams PCM from /api/voice-mute-toggle into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceMuteToggle() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-mute-toggle", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceMuteToggle;
