...
/**
 * Voice Translate Live — Voice recipe
 * SSE-streams PCM from /api/voice-translate-live into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceTranslateLive() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-translate-live", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceTranslateLive;
