...
/**
 * Voice Translate Podcast — Voice recipe
 * SSE-streams PCM from /api/voice-translate-podcast into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceTranslatePodcast() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-translate-podcast", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceTranslatePodcast;
