...
/**
 * Voice Vad — Voice recipe
 * SSE-streams PCM from /api/voice-vad into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceVad() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-vad", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
