...
/**
 * Voice Visualizer Bars — Voice recipe
 * SSE-streams PCM from /api/voice-visualizer-bars into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceVisualizerBars() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-visualizer-bars", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceVisualizerBars;
