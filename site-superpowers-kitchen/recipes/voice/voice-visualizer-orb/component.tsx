...
/**
 * Voice Visualizer Orb — Voice recipe
 * SSE-streams PCM from /api/voice-visualizer-orb into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceVisualizerOrb() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-visualizer-orb", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceVisualizerOrb;
