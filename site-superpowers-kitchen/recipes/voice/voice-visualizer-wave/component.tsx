...
/**
 * Voice Visualizer Wave — Voice recipe
 * SSE-streams PCM from /api/voice-visualizer-wave into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceVisualizerWave() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-visualizer-wave", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceVisualizerWave;
