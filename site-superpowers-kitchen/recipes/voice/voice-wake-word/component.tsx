...
/**
 * Voice Wake Word — Voice recipe
 * SSE-streams PCM from /api/voice-wake-word into a WebAudio context. Honors prefers-reduced-motion for any visualizer.
 */
export function SskVoiceWakeWord() {
  ...
  async function play() {
    ...
    const res = await fetch("/api/voice-wake-word", { method:"POST", headers: { "Content-Type":"application/json" }, body: JSON.stringify({ text }) });
...
export default SskVoiceWakeWord;
